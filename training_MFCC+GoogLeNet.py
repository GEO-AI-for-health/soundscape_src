...
from tensorflow.keras.layers import Input, Dense,  Dropout, Conv2D, MaxPooling2D, AveragePooling2D, \
    concatenate, Flatten
...
def GoogLeNet():
    ...
    x = Conv2D(64,kernel_size=7,strides=2,activation="relu", padding='same')(input)
...
class SGDLearningRateTracker(Callback):
    ...
    def loss_plot(self, loss_type):
        ...
        myfig.savefig(
            '3wavesbestmodels/q4_02_1-3_8-10google_net/' + str(
